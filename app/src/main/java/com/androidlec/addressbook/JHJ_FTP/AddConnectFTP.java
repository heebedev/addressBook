...
public class AddConnectFTP extends AsyncTask<Integer, String, String> {
    ...
    public AddConnectFTP(Context context, String host, String username, String password, int port, Uri file) {
    ...
    protected void onPostExecute(String formatDate) {
        ...
        AddActivity.uploadToDB(context, formatDate);
